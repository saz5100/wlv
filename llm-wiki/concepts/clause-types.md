...
related: [sentence-definition, subordinating-conjunctions, sentence-classifications]
sources: ["abingdon-spag-pocket-guide.md"]
---
# Clause Types

A clause is a group of words containing a subject and a verb. There are two primary types:

## Independent (Main) Clauses
An independent clause makes complete sense on its own and can stand as a full sentence.
